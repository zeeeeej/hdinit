 ...
 */
 ...
 /**
  * gcc -o test_json_rpc test_json_rpc.c -I../includes -L../libs -ljsonrpcc -lev
  * 
  * echo '{"jsonrpc": "2.0", "method": "add", "params": [5, 3], "id": 2}' | nc localhost 1234
  * 
  * echo '{"jsonrpc": "2.0", "method": "sayHello", "id": 1}' | nc localhost 1234
  * 
  * echo '{"jsonrpc": "2.0", "method": "exit", "id": 3}' | nc localhost 1234
  */
 int main(void) {
